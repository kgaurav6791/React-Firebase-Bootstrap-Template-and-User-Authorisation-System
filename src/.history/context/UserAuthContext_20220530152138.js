...
export function useUserAuth() {           // Even though the 'functions and object user' is now available to child components
  return useContext(userAuthContext);     // To actually access these two ,the syntax requires --->>>  const user = useContext(UserContext);
                                            ...
                                            //We are doing this part upto const user here and simply exporting the result user object
